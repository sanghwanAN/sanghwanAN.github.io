...
투입 후 약 2주간에 인수인계 후 바로 2월에 초에 오픈하는 퍼마일자동차 상품 컨텐츠 코딩 및 구축 퍼블리셔들이 끝내지 못한 수정 사항 처리, 오픈기념 이벤트 페이지 코딩 및 현업 들의 추가 요건 대응을 하며 프로젝트를 진행중이며, 현재는 모바일 메인 페이지를 바꾸자는 현업 요청에 의해 모바일 메인 페이지 코딩을 진행 중에 있습니다.
